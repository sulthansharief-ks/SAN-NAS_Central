...
## **Table of Contents 📑**
* [1. Purpose 🎯](#1-purpose)
* [2. The Baseline Convention: CL[#]-[Letter] 🔠](#2-the-baseline-convention)
* [3. The Logical Extension: Host Groups (CL[#]-[Letter]-[ID]) 🔗](#3-the-logical-extension)
* [4. Multipathing & Port Selection Best Practices 🛣️](#4-multipathing-best-practices)
...
## <a id="2-the-baseline-convention"></a>**2. The Baseline Convention: CL[#]-[Letter] 🔠**
...
## <a id="3-the-logical-extension"></a>**3. The Logical Extension: Host Groups (CL[#]-[Letter]-[ID]) 🔗**
...
## <a id="4-multipathing-best-practices"></a>**4. Multipathing & Port Selection Best Practices 🛣️**

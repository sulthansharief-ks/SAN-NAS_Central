# 🚀 Standard Operating Procedure: Hitachi Storage Provisioning & Mapping
**System:** Hitachi VSP G-Series / F-Series / G1000 / G1500  
**Management Tool:** Hitachi Storage Navigator / Device Manager  

## 📑 Table of Contents

### Part 1: LUN Allocation & Provisioning (From Scratch)
1. [1. Purpose 🎯](#alloc-purpose)
2. [2. Prerequisites 📋](#alloc-prereq)
3. [3. Procedure 🛠️](#alloc-procedure)
4. [4. Verification & Finalization ✅](#alloc-verify)
5. [5. Troubleshooting Guide: "Task Failed" 🛠️](#alloc-troubleshoot)

### Part 2: Mapping Existing LDEVs to Host Groups
1. [1. Purpose 🎯](#map-purpose)
2. [2. Prerequisites 📋](#map-prereq)
3. [3. Procedure 🛠️](#map-procedure)
4. [4. Verification & Host Discovery 🔍](#map-verify)
...
<a id="alloc-purpose"></a>
## 🟧 Part 1: Storage LUN Allocation & Provisioning
